...
-- -----------------------------------------------------
-- Table `my_cv`.`meetingrequest`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `my_cv`.`meetingrequest` ;

CREATE TABLE IF NOT EXISTS `my_cv`.`meetingrequest` (
  `idmeeting_request` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `my_cv`.`messages` (
  ...
  `meeting_request_idmeeting_request` INT NULL,
  ...
  INDEX `fk_messages_user1_idx` (`user_id_user` ASC) VISIBLE,
  CONSTRAINT `fk_messages_meeting_request1`
    FOREIGN KEY (`meeting_request_idmeeting_request`)
    REFERENCES `my_cv`.`meetingrequest` (`idmeeting_request`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
